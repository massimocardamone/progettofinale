...
.section-center {
  ...
  .globe {
    ...
    .rotateBall {
    animation: rotateBall 4s ease forwards;
    -webkit-transition: all 300ms linear;
    transition: all 500ms linear;
  }
    .rotateBall2 {
    animation: rotateBall2 4s ease forwards;
    -webkit-transition: all 300ms linear;
    transition: all 500ms linear;
  }
...
let globes = document.querySelectorAll('.globe')
if (globes) {
    globes.forEach(globe => {
        let first = false
        globe.addEventListener('click',()=>{
            if (first == false) {
                globe.classList.add('rotateBall')
                first = true
            }else{
                globe.classList.toggle('rotateBall')
                globe.classList.toggle('rotateBall2')
            }
        })
    });
}
