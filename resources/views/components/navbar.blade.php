...
<<<<<<< HEAD
                ...
                <li class="nav-item">
                    <a class="nav-link mylinks"
                        href="{{ route('article_index') }}">{{ __('messages.Tutti i prodotti') }}</a>
                </li>
                <li class="nav-item">
                    <form class="d-flex align-items-center mysearchbar" role="search"
                        action="{{ route('searchArticle') }}" method="GET">
                        @csrf
                        <input class="form-control myinputsearch me-2" name="searched" type="search"
                            placeholder="{{ __('messages.cerca un prodotto') }}" aria-label="Search">
            ...
            @auth
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown mydrop">
                        <a class="nav-link linkbenvenuto dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            @if (Auth::user()->is_revisor)
                                <li class="dropdown-item">
                                    <a class="nav-link btnalert alert-danger btn-sm position-relative" aria-current="page"
                                        href="{{ route('revisor_index') }}">{{ __('messages.Zona revisione') }}
                                        <span
                                            class="position-absolute top-0 start-75 translate_middle badge ruonded-pill bg-danger">
                                            {{ App\Models\Article::toBeRevisionedCount() }}
                                        </span>
                                    </a>
                            ...
                            <li class="dropdown-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="{{ route('create') }}">{{ __('messages.Aggiungi un prodotto') }}</a>
                                </li>
                            @endauth
                    </li>
                    <li class="dropdown-item">
...
>>>>>>> 27f61a37005c1ea668a62353908bfe7d54bbb5d6
    </div>
</nav>
